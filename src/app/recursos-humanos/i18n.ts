...
export const diccionarioRecursosHumanos: Diccionario<Clave> = {
  ES: {
    ...
    errorTelefonoObligatorio: 'El teléfono es obligatorio (con código de país) — es la clave para no duplicar el registro.',
  ...
  PT: {
    ...
    errorTelefonoObligatorio: 'O telefone é obrigatório (com código do país) — é a chave para não duplicar o registro.',
