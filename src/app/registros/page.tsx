...
export default function RegistrosPage() {
  ...
  return (
    <Pantalla
      ...
      subtitulo='Consultá las operaciones contables registradas en tu empresa.'
    >
      <input
        value={busqueda}
    ...
    <div style={fondo}>
      <div style={{ maxWidth: 1180, margin: '0 auto' }}>
        <header style={encabezado}>
          ...
          <p style={eyebrow}>GESTIÓN FINANCIERA</p>
