...
export const diccionarioPanelControl: Diccionario<ClavePanelControl> = {
  ES: {
    ...
    subtituloDistribucionIngresos: 'De dónde vino la plata este período',
    vacioDistribucionIngresos: 'Todavía no hay ingresos registrados en este período.',
  ...
  PT: {
    ...
    subtituloDistribucionIngresos: 'De onde veio o dinheiro neste período',
    vacioDistribucionIngresos: 'Ainda não há receitas registradas neste período.',
