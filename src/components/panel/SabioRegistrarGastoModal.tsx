...
// MINI-DIÁLOGO DE SABIO PARA REGISTRAR UN GASTO RECURRENTE
// ==========================================================
//
// Se abre al tocar el globo de diálogo de Sabio (en el encabezado o
// en la versión flotante) cuando hay un gasto recurrente por vencer
// o vencido — permite confirmar (o ajustar) el monto y registrar el
// Pago sin salir de Panel de Controle. El único campo que tiene
// sentido tocar acá es el monto (categoría y forma de pago ya
// quedaron fijadas al cargar la plantilla en Mis Vencimientos); si
// se necesita cambiar algo más, sigue estando "Registrar" desde ahí,
...
export function SabioRegistrarGastoModal({
  empresaId,
  recordatorio,
  idioma,
  simbolo,
  ...
  async function confirmar() {
    ...
    try {
      await registrarPagoRecordatorio(empresaId, recordatorio, montoNumero);
      onRegistrado();
    } catch (e) {
    ...
    >
      ...
      >
        ...
        <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: colores.azul, marginBottom: 6 }}>
          {esPT ? 'Valor a pagar' : 'Monto a pagar'}
        </label>
